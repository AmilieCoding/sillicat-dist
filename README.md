# Sillicat Dist
Sillicat distribution repo, a fun client I'm working on that is 100% skidded from a youtube guide.<br>
...
Set your working directory to have /test_run/ on the end.
