...
import sillicat.util.alts.Alt;
import sillicat.util.alts.impl.*;
...
public class GUIAltManager extends GuiScreen {
    ...
    class AltButton {
        ...
        public void render(int mouseX, int mouseY, float partialTicks) {
            ...
            // Render button label
            RenderUtil.drawRect(x, y, width, height,  new java.awt.Color(23, 23, 23).getRGB());
            Sillicat.INSTANCE.getFontManager().getFunnel().size(24).drawCenteredString(label, x + width / 2f, y + height / 2f, -1);
    ...
    class RenderedAlt {
        ...
        public void render(int mouseX, int mouseY, float partialTicks) {
            ...
            // Render alt label`
            RenderUtil.drawRect(x,  y, width, height,  new java.awt.Color(23, 23, 23).getRGB());
            CustomFontRenderer font = Sillicat.INSTANCE.getFontManager().getFunnel().size(24);
            String displayName = alt.getUsername();
            if(alt instanceof SessionAlt) {
                SessionAlt sessionAlt = (SessionAlt)alt;
                ...
                if(timeLeft > 0) {
                    ...
                    Sillicat.INSTANCE.getFontManager().getFunnel().size(16).drawCenteredString("Session valid for: " + timeLeftStr,
    ...
    private void reloadAlts() {
        ...
        this.alts.clear();
        this.alts = new ArrayList<>(Sillicat.INSTANCE.getAltManager().getAlts());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        CustomFontRenderer big = Sillicat.INSTANCE.getFontManager().getFunnel().size(48);
        CustomFontRenderer medium = Sillicat.INSTANCE.getFontManager().getFunnel().size(24);
        CustomFontRenderer small = Sillicat.INSTANCE.getFontManager().getFunnel().size(18);
        ...
        RenderUtil.drawRect(posX - 8, posY - 24, (72 * 2) + 14 + 12, 26,  new java.awt.Color(23, 23, 23).getRGB());
        RenderUtil.drawRect(posX - 8, posY - 3, (72 * 2) + 14 + 12, 200,  new java.awt.Color(42, 42, 42).getRGB());
        ...
        RenderUtil.drawRect((sr.getScaledWidth_double() / 2f) - 150, 76, 300, 26, new java.awt.Color(42, 42, 42).getRGB());
