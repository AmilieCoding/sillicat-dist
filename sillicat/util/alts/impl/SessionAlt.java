package sillicat.util.alts.impl;
...
public class SessionAlt extends Alt {
    ...
    public void login() {
        ...
        future.thenAcceptAsync(result -> {
            ...
            if(Sillicat.INSTANCE.getAltManager().alreadyIn(this)){
                // delete old
                Sillicat.INSTANCE.getAltManager().getAlts().removeIf(a -> a.username.equals(this.username) && a instanceof SessionAlt);
            }

            Sillicat.INSTANCE.getAltManager().addAlt(this);
            this.status = Status.SUCCESS;
